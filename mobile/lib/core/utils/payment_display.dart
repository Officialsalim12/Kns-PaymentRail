...
class PaymentDisplay {
  ...
  static const double platformFeePercentage =
      transferFeePercentage + serviceFeePercentage;
  ...
  static double calculateTotalDisplayAmount(
  ...
  static double calculateCompletedPaymentsDisplayAmount(
      List<Map<String, dynamic>> payments) {
    return payments.where((p) => p['payment_status'] == 'completed').fold(0.0,
        (sum, payment) {
