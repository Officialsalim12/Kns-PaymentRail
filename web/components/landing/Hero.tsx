...
export default function Hero() {
    return (
        <section className="relative bg-gradient-to-br from-primary-50 via-white to-primary-50 pt-64 pb-16 sm:pt-44 md:pt-40 lg:pt-48 lg:pb-32 xl:pt-56 xl:pb-40 overflow-hidden">
