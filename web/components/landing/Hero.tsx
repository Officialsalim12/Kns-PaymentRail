...
export default function Hero() {
    return (
        <section className="relative bg-gradient-to-br from-primary-50 via-white to-primary-50 pt-28 pb-16 sm:pt-32 sm:pb-24 md:pt-40 md:pb-28 lg:pt-48 lg:pb-32 xl:pt-56 xl:pb-40 overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-4xl mx-auto px-1 sm:px-0">
                    <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-gray-900 mb-4 sm:mb-6 leading-tight">
                        <span className="block">
                            Modern Subscription &amp; Fundraising Collections Platform for
                        </span>
                    ...
                    <p className="text-sm sm:text-lg md:text-xl text-gray-600 mb-6 sm:mb-10 max-w-3xl mx-auto leading-relaxed px-2">
                        Sierra Leone&apos;s most reliable subscription and fundraising collections platform, an end-to-end solution that improves collections and streamlines finances. We help organizations grow revenue and retain members.
                    </p>
