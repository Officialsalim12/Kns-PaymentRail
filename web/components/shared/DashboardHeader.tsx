                ...
                <div className="flex items-center justify-between gap-1 sm:gap-4">
                    ...
                    <div className="flex items-center gap-1.5 xs:gap-3 sm:gap-4">
                        {onMenuClick && (
                            <button
                                onClick={onMenuClick}
                                className="lg:hidden p-1.5 xs:p-2 rounded-xl text-gray-500 hover:text-primary-600 hover:bg-primary-50 transition-all active:scale-95"
                    ...
                    <div className="flex items-center gap-0.5 xs:gap-1 sm:gap-3">
                        {/* Quick Actions Group */}
                        <div className="flex items-center gap-0 xs:gap-0.5 sm:gap-2 mr-0.5 xs:mr-1 sm:mr-2 border-r border-gray-100 pr-0.5 xs:pr-1 sm:pr-2">
                            <Link
                        ...
                        {/* User Profile */}
                        <div className="flex items-center gap-1 xs:gap-2 sm:gap-3 pl-0.5 xs:pl-1 sm:pl-2">
                            ...
                            >
                                <div className="h-7 w-7 xs:h-8 xs:w-8 sm:h-11 sm:w-11 relative rounded-2xl overflow-hidden ring-2 ring-gray-100 ring-offset-2 group-hover:ring-primary-200 transition-all">
                                    {profilePhotoUrl ? (
                                        <Image
                                            src={profilePhotoUrl}
                                            alt={userFullName}
