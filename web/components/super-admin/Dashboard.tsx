        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
          ...
          >
            ...
            {stats.pendingPasswordResets > 0 && (
              <span className="mb-2 bg-purple-100 text-purple-700 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">
                {stats.pendingPasswordResets} Requests
              </span>
            )}
            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Resets</p>
            <p className="text-3xl font-bold text-gray-900 group-hover:text-purple-600 transition-colors">{stats.pendingPasswordResets}</p>
          </Link>
        </div>
